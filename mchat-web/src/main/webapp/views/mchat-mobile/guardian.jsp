...
<div style=" position:absolute; display:none; top:0;z-index:999; background-color:#FFF; height:100%" class="p_read">
    ...
    <p>
        <span style="color:#333333;font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp; M-CHAT-R/F筛查量表是从国外引进的心理测量量表，填写测试问卷的时长为5-10分钟，主要针对16-30个月的婴幼儿进行的社会性心理行为发育的评估。良好的社会性是心理健康的标志之一，是人作为社会人所表现出来的属性，游戏技巧、分享、合作、社会交往等行为与婴幼儿社会性的发展息息相关。社会性发育落后可能表现为孤僻、不合群、言语发育迟缓、社交（沟通）障碍等。</span>
    </p>
    <p>
    	<span style="color:#333333;font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp; M-CHAT-R/F已得到美国儿科学会的推荐，是目前在美国以及国际上最广泛用于筛查婴幼儿社会性心理行为发育的工具之一。在包括美国、英国、瑞典、日本、韩国在内的20多个国家或地区的临床和研究中被大量使用。</span>
    </p>
    <p>
        <br />
    </p>
    <strong><span style="font-size:16px;">MCHAT-R/F一共有两部分组成：</span></strong><br />
    <span style="color:#333333;font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;第一部分<span style="font-weight: bold;">初筛问卷</span>，包含20个条目，每个条目只有"是"和"否"两个选 项，由主要照养人根据孩子的行为表现进行评定。</span><br />
    <span style="color:#333333;font-size:16px;"> &nbsp;&nbsp;&nbsp;&nbsp;第二部分为<span style="font-weight: bold;">后续访谈</span>，对于在初筛问卷结果为阳性的儿童，医护人员会与家长进行一个结构性的访谈，目的是为了对初筛问卷中的部分条目进行确认。</span>
    </div>
</div>
<!--弹出层内容结束-->
</body>
