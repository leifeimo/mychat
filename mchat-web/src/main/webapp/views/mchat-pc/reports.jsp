...
.search_list_th p:nth-child(9){
	width:8%;
}
.search_list_th p:nth-child(10){
	width:8%;
}
.search_list_th p:nth-child(11){
	width:8%;
}
.search_list_th p:nth-child(12){
	width:8%;
}
.search_list_th p:nth-child(13){
	width:5%;
}
...
.search_list_th_ul span:nth-child(9){
	width:8%;
}
.search_list_th_ul span:nth-child(10){
	width:8%;
}
.search_list_th_ul span:nth-child(11){
	width:8%;
}
.search_list_th_ul span:nth-child(12){
	width:8%;
}
.search_list_th_ul span:nth-child(13){
	width:5%;
}
</style>
</head>
    ...
    <div class="s_mid">
        <div class="s_mid_t">
            ...
            <div class="l_menu">
              ...
              <div class="l_m_2">
                  <p class="l_menu_2_1"><a href="#">儿童查询</a></p>
                  <p class="l_menu_2_2 l_m_current"><a href="#">报告查询</a></p>
                     ...
                     <div class="search_list_th_ul">
                         <ul class="search_ul">
                           <li>
                             ...
                             <span>M-CHAT</span>
                             <span>2015-10-3</span>
                             <span><a href="#"><img src="<%=basePath%>images/s_2.png" /></a></span>
                             <span><a href="#"><img src="<%=basePath%>images/s_2.png" /></a></span>
                             <span><a href="#"><img src="<%=basePath%>images/s_2.png" /></a></span>
                             <span><a href="#"><img src="<%=basePath%>images/s_2.png" /></a></span>
                             <span><a href="#"><img src="<%=basePath%>images/s_1.png" /></a></span>
                           </li>
